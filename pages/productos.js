  ...
  return (
    <main>
      ...
      <section>
        ...
        <div className="flex justify-center">
          <div>
            <a className="bg-purple-600 w-12 px-8 py-2 font-semibold text-lg rounded-lg shadow-lg text-white" target="_blank" rel="noopener noreferrer" href="https://juventidades.sociales.unam.mx/videos/">Ir al sitio web</a>
          </div>
        </div>
      </section>
      <hr />
